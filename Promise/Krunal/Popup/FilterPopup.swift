...
class FilterPopup: UIViewController {
    ...
    //MARK:- Initialization
    func Initialization() {
        self.btn_Apply.addTarget(self, action: #selector(btn_Apply_Click1(_:)), for: .touchUpInside)
    ...
    @objc func btn_Apply_Click(_ Button : UIButton) {
        ...
        if Str_FilterVC == "Onsite" || Str_FilterVC == "Shipped_Status" {
            if btn_FirstFilter.currentTitle! ==  "Project Name" {
                if  btn_SecondFilter.currentTitle! == "Contains" {
                    self.Str_Filter_String = Filter_onSite_Shipped.GET_Filter_ProjectName + Second_Filter_Value.GET_Filter_icontains
                }else if  self.btn_SecondFilter.currentTitle! == "Start with" {
                    self.Str_Filter_String = Filter_onSite_Shipped.GET_Filter_ProjectName + Second_Filter_Value.GET_Filter_istartswith
                }else if self.btn_SecondFilter.currentTitle! == "Equal" {
                    self.Str_Filter_String = Filter_onSite_Shipped.GET_Filter_ProjectName + Second_Filter_Value.GET_Filter_Equal
                }
            }else if btn_FirstFilter.currentTitle! ==  "Vendor Name" {
                if  btn_SecondFilter.currentTitle! == "Contains" {
                    self.Str_Filter_String = Filter_onSite_Shipped.GET_Filter_VendorName
                }else if  btn_SecondFilter.currentTitle! == "Start with" {
                    self.Str_Filter_String = Filter_onSite_Shipped.GET_Filter_VendorName + Second_Filter_Value.GET_Filter_istartswith
                }else if btn_SecondFilter.currentTitle! == "Equal" {
                    self.Str_Filter_String = Filter_onSite_Shipped.GET_Filter_VendorName + Second_Filter_Value.GET_Filter_Equal
                }
            }else if btn_FirstFilter.currentTitle! ==  "Purchase Order Number" {
                if  btn_SecondFilter.currentTitle! == "Contains" {
                    self.Str_Filter_String = Filter_onSite_Shipped.GET_Filter_PurchaseOrderNumber
                }else if  btn_SecondFilter.currentTitle! == "Start with" {
                    self.Str_Filter_String = Filter_onSite_Shipped.GET_Filter_PurchaseOrderNumber + Second_Filter_Value.GET_Filter_istartswith
                }else if self.btn_SecondFilter.currentTitle! == "Equal" {
                    self.Str_Filter_String = Filter_onSite_Shipped.GET_Filter_PurchaseOrderNumber + Second_Filter_Value.GET_Filter_Equal
                }
            }else if btn_FirstFilter.currentTitle! ==  "PL Number" {
                if  btn_SecondFilter.currentTitle! == "Contains" {
                    self.Str_Filter_String = Filter_onSite_Shipped.GET_Filter_PLNumber
                }else if  btn_SecondFilter.currentTitle! == "Start with" {
                    self.Str_Filter_String = Filter_onSite_Shipped.GET_Filter_PLNumber + Second_Filter_Value.GET_Filter_istartswith
                }else if self.btn_SecondFilter.currentTitle! == "Equal" {
                    self.Str_Filter_String = Filter_onSite_Shipped.GET_Filter_PLNumber + Second_Filter_Value.GET_Filter_Equal
                }
            ...
            if btn_FirstFilter.currentTitle! ==  "Project Name" {
                if  btn_SecondFilter.currentTitle! == "Contains" {
                    self.Str_Filter_String = Filter_shopDrawing.GET_Filter_Project_Name + Second_Filter_Value.GET_Filter_icontains
                }else if  btn_SecondFilter.currentTitle! == "Start with" {
                    self.Str_Filter_String = Filter_shopDrawing.GET_Filter_Project_Name + Second_Filter_Value.GET_Filter_istartswith
                }else if self.btn_SecondFilter.currentTitle! == "Equal" {
                    self.Str_Filter_String = Filter_shopDrawing.GET_Filter_Project_Name + Second_Filter_Value.GET_Filter_Equal
                }
            }else if self.btn_FirstFilter.currentTitle! ==  "Group Name" {
                if  btn_SecondFilter.currentTitle! == "Contains" {
                    self.Str_Filter_String = Filter_shopDrawing.GET_Filter_Group_Name + Second_Filter_Value.GET_Filter_icontains
                }else if  btn_SecondFilter.currentTitle! == "Start with" {
                    self.Str_Filter_String = Filter_shopDrawing.GET_Filter_Group_Name + Second_Filter_Value.GET_Filter_istartswith
                }else if self.btn_SecondFilter.currentTitle! == "Equal" {
                    self.Str_Filter_String = Filter_shopDrawing.GET_Filter_Group_Name + Second_Filter_Value.GET_Filter_Equal
                }
            }else if self.btn_FirstFilter.currentTitle! ==  "Strucher Id" {
                if  btn_SecondFilter.currentTitle! == "Contains" {
                    self.Str_Filter_String = Filter_shopDrawing.GET_Filter_Strucher_Id + Second_Filter_Value.GET_Filter_icontains
                }else if  btn_SecondFilter.currentTitle! == "Start with" {
                    self.Str_Filter_String = Filter_shopDrawing.GET_Filter_Strucher_Id + Second_Filter_Value.GET_Filter_istartswith
                }else if self.btn_SecondFilter.currentTitle! == "Equal" {
                    self.Str_Filter_String = Filter_shopDrawing.GET_Filter_Strucher_Id + Second_Filter_Value.GET_Filter_Equal
                }
            }else if self.btn_FirstFilter.currentTitle! == "Approval Status" {
                if  btn_SecondFilter.currentTitle! == "Contains" {
                    self.Str_Filter_String = Filter_shopDrawing.GET_Filter_Approval_Status + Second_Filter_Value.GET_Filter_icontains
                }else if  btn_SecondFilter.currentTitle! == "Start with" {
                    self.Str_Filter_String = Filter_shopDrawing.GET_Filter_Approval_Status + Second_Filter_Value.GET_Filter_istartswith
                }else if self.btn_SecondFilter.currentTitle! == "Equal" {
                    self.Str_Filter_String = Filter_shopDrawing.GET_Filter_Approval_Status + Second_Filter_Value.GET_Filter_Equal
                }
            }else if self.btn_FirstFilter.currentTitle! == "Doc Status" {
                if  btn_SecondFilter.currentTitle! == "Contains" {
                    self.Str_Filter_String = Filter_shopDrawing.GET_Filter_Doc_Status + Second_Filter_Value.GET_Filter_icontains
                }else if  btn_SecondFilter.currentTitle! == "Start with" {
                    self.Str_Filter_String = Filter_shopDrawing.GET_Filter_Doc_Status + Second_Filter_Value.GET_Filter_istartswith
                }else if self.btn_SecondFilter.currentTitle! == "Equal" {
                    self.Str_Filter_String = Filter_shopDrawing.GET_Filter_Doc_Status + Second_Filter_Value.GET_Filter_Equal
                }
            ...
            if btn_FirstFilter.currentTitle! ==  "Project Name" {
                if  btn_SecondFilter.currentTitle! == "Contains" {
                    self.Str_Filter_String = Filter_packingList.GET_Filter_Project_Name + Second_Filter_Value.GET_Filter_icontains
                }else if  btn_SecondFilter.currentTitle! == "Start with" {
                    self.Str_Filter_String = Filter_packingList.GET_Filter_Project_Name + Second_Filter_Value.GET_Filter_istartswith
                }else if self.btn_SecondFilter.currentTitle! == "Equal" {
                    self.Str_Filter_String = Filter_packingList.GET_Filter_Project_Name + Second_Filter_Value.GET_Filter_Equal
                }
            }else if self.btn_FirstFilter.currentTitle! ==  "Vendor Name" {
                if  btn_SecondFilter.currentTitle! == "Contains" {
                    self.Str_Filter_String = Filter_packingList.GET_Filter_Vendor_Name + Second_Filter_Value.GET_Filter_icontains
                }else if  btn_SecondFilter.currentTitle! == "Start with" {
                    self.Str_Filter_String = Filter_packingList.GET_Filter_Vendor_Name + Second_Filter_Value.GET_Filter_istartswith
                }else if self.btn_SecondFilter.currentTitle! == "Equal" {
                    self.Str_Filter_String = Filter_packingList.GET_Filter_Vendor_Name + Second_Filter_Value.GET_Filter_Equal
                }
            }else if self.btn_FirstFilter.currentTitle! ==  "Group name" {
                if  btn_SecondFilter.currentTitle! == "Contains" {
                    self.Str_Filter_String = Filter_packingList.GET_Filter_Group_name + Second_Filter_Value.GET_Filter_icontains
                }else if  btn_SecondFilter.currentTitle! == "Start with" {
                    self.Str_Filter_String = Filter_packingList.GET_Filter_Group_name + Second_Filter_Value.GET_Filter_istartswith
                }else if self.btn_SecondFilter.currentTitle! == "Equal" {
                    self.Str_Filter_String = Filter_packingList.GET_Filter_Group_name + Second_Filter_Value.GET_Filter_Equal
                }
            }else if self.btn_FirstFilter.currentTitle! == "Strucher Id" {
                if  btn_SecondFilter.currentTitle! == "Contains" {
                    self.Str_Filter_String = Filter_packingList.GET_Filter_Strucher_Id + Second_Filter_Value.GET_Filter_icontains
                }else if  btn_SecondFilter.currentTitle! == "Start with" {
                    self.Str_Filter_String = Filter_packingList.GET_Filter_Strucher_Id + Second_Filter_Value.GET_Filter_istartswith
                }else if self.btn_SecondFilter.currentTitle! == "Equal" {
                    self.Str_Filter_String = Filter_packingList.GET_Filter_Strucher_Id + Second_Filter_Value.GET_Filter_Equal
                }
            }else if self.btn_FirstFilter.currentTitle! == "PL Number" {
                if  btn_SecondFilter.currentTitle! == "Contains" {
                    self.Str_Filter_String = Filter_packingList.GET_Filter_PL_Number + Second_Filter_Value.GET_Filter_icontains
                }else if  btn_SecondFilter.currentTitle! == "Start with" {
                    self.Str_Filter_String = Filter_packingList.GET_Filter_PL_Number + Second_Filter_Value.GET_Filter_istartswith
                }else if self.btn_SecondFilter.currentTitle! == "Equal" {
                    self.Str_Filter_String = Filter_packingList.GET_Filter_PL_Number + Second_Filter_Value.GET_Filter_Equal
                }
            }else if self.btn_FirstFilter.currentTitle! == "Package Name" {
                if  btn_SecondFilter.currentTitle! == "Contains" {
                    self.Str_Filter_String = Filter_packingList.GET_Filter_Package_Name + Second_Filter_Value.GET_Filter_icontains
                }else if  btn_SecondFilter.currentTitle! == "Start with" {
                    self.Str_Filter_String = Filter_packingList.GET_Filter_Package_Name + Second_Filter_Value.GET_Filter_istartswith
                }else if self.btn_SecondFilter.currentTitle! == "Equal" {
                    self.Str_Filter_String = Filter_packingList.GET_Filter_Package_Name + Second_Filter_Value.GET_Filter_Equal
                }
            }else if self.btn_FirstFilter.currentTitle! == "Approval Status" {
                if  btn_SecondFilter.currentTitle! == "Contains" {
                    self.Str_Filter_String = Filter_packingList.GET_Filter_Approval_Status + Second_Filter_Value.GET_Filter_icontains
                }else if  btn_SecondFilter.currentTitle! == "Start with" {
                    self.Str_Filter_String = Filter_packingList.GET_Filter_Approval_Status + Second_Filter_Value.GET_Filter_istartswith
                }else if self.btn_SecondFilter.currentTitle! == "Equal" {
                    self.Str_Filter_String = Filter_packingList.GET_Filter_Approval_Status + Second_Filter_Value.GET_Filter_Equal
                }
            }else if self.btn_FirstFilter.currentTitle! == "Status" {
                if  btn_SecondFilter.currentTitle! == "Contains" {
                    self.Str_Filter_String = Filter_packingList.GET_Filter_Status + Second_Filter_Value.GET_Filter_icontains
                }else if  btn_SecondFilter.currentTitle! == "Start with" {
                    self.Str_Filter_String = Filter_packingList.GET_Filter_Status + Second_Filter_Value.GET_Filter_istartswith
                }else if self.btn_SecondFilter.currentTitle! == "Equal" {
                    self.Str_Filter_String = Filter_packingList.GET_Filter_Status + Second_Filter_Value.GET_Filter_Equal
                }
            }else if self.btn_FirstFilter.currentTitle! == "Is Released" {
            ...
            if btn_FirstFilter.currentTitle! ==  "Project Code" {
                if  btn_SecondFilter.currentTitle! == "Contains" {
                    self.Str_Filter_String = Filter_project.GET_Filter_Project_Code + Second_Filter_Value.GET_Filter_icontains
                }else if  btn_SecondFilter.currentTitle! == "Start with" {
                    self.Str_Filter_String = Filter_project.GET_Filter_Project_Code + Second_Filter_Value.GET_Filter_istartswith
                }else if self.btn_SecondFilter.currentTitle! == "Equal" {
                    self.Str_Filter_String = Filter_project.GET_Filter_Project_Code + Second_Filter_Value.GET_Filter_Equal
                }
            }else if self.btn_FirstFilter.currentTitle! ==  "Project Name" {
                if  btn_SecondFilter.currentTitle! == "Contains" {
                    self.Str_Filter_String = Filter_project.GET_Filter_Project_Name + Second_Filter_Value.GET_Filter_icontains
                }else if  btn_SecondFilter.currentTitle! == "Start with" {
                    self.Str_Filter_String = Filter_project.GET_Filter_Project_Name + Second_Filter_Value.GET_Filter_istartswith
                }else if self.btn_SecondFilter.currentTitle! == "Equal" {
                    self.Str_Filter_String = Filter_project.GET_Filter_Project_Name + Second_Filter_Value.GET_Filter_Equal
                }
            }else if self.btn_FirstFilter.currentTitle! ==  "Site Location" {
                if  btn_SecondFilter.currentTitle! == "Contains" {
                    self.Str_Filter_String = Filter_project.GET_Filter_Site_Location + Second_Filter_Value.GET_Filter_icontains
                }else if  btn_SecondFilter.currentTitle! == "Start with" {
                    self.Str_Filter_String = Filter_project.GET_Filter_Site_Location + Second_Filter_Value.GET_Filter_istartswith
                }else if self.btn_SecondFilter.currentTitle! == "Equal" {
                    self.Str_Filter_String = Filter_project.GET_Filter_Site_Location + Second_Filter_Value.GET_Filter_Equal
                }
            }else if self.btn_FirstFilter.currentTitle! == "Manager Name" {
                if  btn_SecondFilter.currentTitle! == "Contains" {
                    self.Str_Filter_String = Filter_project.GET_Filter_Manager_Name + Second_Filter_Value.GET_Filter_icontains
                }else if  btn_SecondFilter.currentTitle! == "Start with" {
                    self.Str_Filter_String = Filter_project.GET_Filter_Manager_Name + Second_Filter_Value.GET_Filter_istartswith
                }else if self.btn_SecondFilter.currentTitle! == "Equal" {
                    self.Str_Filter_String = Filter_project.GET_Filter_Manager_Name + Second_Filter_Value.GET_Filter_Equal
                }
            }else if self.btn_FirstFilter.currentTitle! == "Refrences" {
                if  btn_SecondFilter.currentTitle! == "Contains" {
                    self.Str_Filter_String = Filter_project.GET_Filter_Refrences + Second_Filter_Value.GET_Filter_icontains
                }else if  btn_SecondFilter.currentTitle! == "Start with" {
                    self.Str_Filter_String = Filter_project.GET_Filter_Refrences + Second_Filter_Value.GET_Filter_istartswith
                }else if self.btn_SecondFilter.currentTitle! == "Equal" {
                    self.Str_Filter_String = Filter_project.GET_Filter_Refrences + Second_Filter_Value.GET_Filter_Equal
                }
            ...
            if btn_FirstFilter.currentTitle! ==  "Project Name" {
                if  btn_SecondFilter.currentTitle! == "Contains" {
                    self.Str_Filter_String = Filter_packages.GET_Filter_Project_Name + Second_Filter_Value.GET_Filter_icontains
                }else if  btn_SecondFilter.currentTitle! == "Start with" {
                    self.Str_Filter_String = Filter_packages.GET_Filter_Project_Name + Second_Filter_Value.GET_Filter_istartswith
                }else if self.btn_SecondFilter.currentTitle! == "Equal" {
                    self.Str_Filter_String = Filter_packages.GET_Filter_Project_Name + Second_Filter_Value.GET_Filter_Equal
                }
            }else if self.btn_FirstFilter.currentTitle! ==  "Vendor Name" {
                if  btn_SecondFilter.currentTitle! == "Contains" {
                    self.Str_Filter_String = Filter_packages.GET_Filter_VendorName + Second_Filter_Value.GET_Filter_icontains
                }else if  btn_SecondFilter.currentTitle! == "Start with" {
                    self.Str_Filter_String = Filter_packages.GET_Filter_VendorName + Second_Filter_Value.GET_Filter_istartswith
                }else if self.btn_SecondFilter.currentTitle! == "Equal" {
                    self.Str_Filter_String = Filter_packages.GET_Filter_VendorName + Second_Filter_Value.GET_Filter_Equal
                }
            }else if self.btn_FirstFilter.currentTitle! ==  "Group name" {
                if  btn_SecondFilter.currentTitle! == "Contains" {
                    self.Str_Filter_String = Filter_packages.GET_Filter_Group_name + Second_Filter_Value.GET_Filter_icontains
                }else if  btn_SecondFilter.currentTitle! == "Start with" {
                    self.Str_Filter_String = Filter_packages.GET_Filter_Group_name + Second_Filter_Value.GET_Filter_istartswith
                }else if self.btn_SecondFilter.currentTitle! == "Equal" {
                    self.Str_Filter_String = Filter_packages.GET_Filter_Group_name + Second_Filter_Value.GET_Filter_Equal
                }
            }else if self.btn_FirstFilter.currentTitle! == "Strucher Id" {
                if  btn_SecondFilter.currentTitle! == "Contains" {
                    self.Str_Filter_String = Filter_packages.GET_Filter_Strucher_Id + Second_Filter_Value.GET_Filter_icontains
                }else if  btn_SecondFilter.currentTitle! == "Start with" {
                    self.Str_Filter_String = Filter_packages.GET_Filter_Strucher_Id + Second_Filter_Value.GET_Filter_istartswith
                }else if self.btn_SecondFilter.currentTitle! == "Equal" {
                    self.Str_Filter_String = Filter_packages.GET_Filter_Strucher_Id + Second_Filter_Value.GET_Filter_Equal
                }
            }else if self.btn_FirstFilter.currentTitle! == "Approval Status" {
                if  btn_SecondFilter.currentTitle! == "Contains" {
                    self.Str_Filter_String = Filter_packages.GET_Filter_Approval_Status + Second_Filter_Value.GET_Filter_icontains
                }else if btn_SecondFilter.currentTitle! == "Start with" {
                    self.Str_Filter_String = Filter_packages.GET_Filter_Approval_Status + Second_Filter_Value.GET_Filter_istartswith
                }else if self.btn_SecondFilter.currentTitle! == "Equal" {
                    self.Str_Filter_String = Filter_packages.GET_Filter_Approval_Status + Second_Filter_Value.GET_Filter_Equal
                }
            }else if self.btn_FirstFilter.currentTitle! == "status" {
                if  btn_SecondFilter.currentTitle! == "Contains" {
                    self.Str_Filter_String = Filter_packages.GET_Filter_status + Second_Filter_Value.GET_Filter_icontains
                }else if  btn_SecondFilter.currentTitle! == "Start with" {
                    self.Str_Filter_String = Filter_packages.GET_Filter_status + Second_Filter_Value.GET_Filter_istartswith
                }else if self.btn_SecondFilter.currentTitle! == "Equal" {
                    self.Str_Filter_String = Filter_packages.GET_Filter_status + Second_Filter_Value.GET_Filter_Equal
                }
    ...
    @objc func btn_Apply_Click1(_ Button : UIButton) {
        //-----------------Onsite And Shipped Status Final Filter Param----------------------//
        if Str_FilterVC == "Onsite" || Str_FilterVC == "Shipped_Status" {
            if btn_FirstFilter.currentTitle! ==  "Project Name" {
